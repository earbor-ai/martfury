...
const ShoppingCartScreen = ({ ecomerce }) => {
    const { products, getProducts,applyCouponDiscount } = useEcomerce();

    function handleApplyCouponDiscount(e, couponDiscount) { 
        e.preventDefault();
        //alert (couponDiscount);
        applyCouponDiscount({ couponCode: couponDiscount}, ecomerce.cartItems);
    }
                                        ...
                                        <figure>
                                            ...
                                            <div className="form-group">
                                                <button className="ps-btn ps-btn--outline"
                                                    onClick={(e) => handleApplyCouponDiscount(e, couponCode)}>
                                                    Apply
                                                </button>
                                            </div>
                                        </figure>
