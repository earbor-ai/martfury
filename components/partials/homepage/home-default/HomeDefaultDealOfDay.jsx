...
const HomeDefaultDealOfDay = ({ collectionSlug}) => {
    ...
    const { productItems, collection, loading, getProductsByCollection } = useGetProducts();
    ...
    if (!loading) {        
        ...
        if (productItems && productItems.length > 0) {            
            endDateUtc=collection['AppliedDiscountDetails'][0]['EndDateUtc'];        
                    ...
                    <div className="ps-block--countdown-deal">
                        ...
                        <div className="ps-block__right">                        
                            <figure>
                                ...
                                <CountDownSimple                                                                    
                                    //timeTillDate="12 11 2021, 3:30 pm"                                    
                                    timeTillDate={endDateUtc}
