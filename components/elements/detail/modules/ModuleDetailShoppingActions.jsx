...
const ModuleDetailShoppingActions = ({
    ...
    function handleAddItemToCart(e) {
        ...
        //MISSING: Modal popup not being shown as in wishlist
        const modal = Modal.success({
            centered: true,
            title: 'Success!',
            content: `This product has been added to shopping cart !`,
        });
        modal.update;
    }
    ...
    const handleAddItemToWishlist = (e) => {
        ...
        const modal = Modal.success({
            centered: true,
            title: 'Success!',
            content: `This item has been added to your wishlistt`,
        });
        modal.update;
    };
    ...
    if (!extended) {
        return (
            <div className="ps-product__shopping">
                {/*<figure>
                    <figcaption>Quantity111</figcaption>
